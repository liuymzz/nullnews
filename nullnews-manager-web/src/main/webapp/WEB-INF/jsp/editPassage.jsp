...
<div class="tpl-page-container tpl-page-header-fixed">
	...
	<div class="tpl-content-wrapper">
		<div class="tpl-content-page-title">NULL科技小编文章列表</div>
		<ol class="am-breadcrumb">
			<li><a href="#" class="am-icon-home">首页</a></li>
			<li><a href="#">文章管理</a></li>
			<li class="am-active">小编文章列表</li>
		</ol>
		<div class="tpl-portlet-components">
			<div class="portlet-title">
				<div class="caption font-green bold">
					<span class="am-icon-code"></span>小编文章列表
				</div>
					...
					<div class="tpl-table-images">
						<div class="am-u-sm-12 am-u-md-6 am-u-lg-4">
								<div class="tpl-table-images-content">
									...
									<div class="tpl-table-images-content-i-time">发布时间：<fmt:formatDate value ="${passageAnduser.passage.passageTime}" pattern="yyyy-MM-dd HH:mm:ss" /></div>
