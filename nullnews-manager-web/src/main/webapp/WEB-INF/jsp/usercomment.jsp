                        ...
                        <div class="am-u-sm-12">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                    <c:forEach items="${pageInfo.list}" var="usercomment">
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td>${usercomment.userName}</td>
                                            <td><a href="#">${usercomment.commentContent}</a></td>
                                            <td class="am-hide-sm-only"><fmt:formatDate value ="${usercomment.commentTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
